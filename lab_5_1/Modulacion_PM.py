...
from Envolvente_compleja_PM_L1A import Envolvente_compleja_PM_L1A  # grc-generated hier_block
...
class Modulacion_PM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.Envolvente_compleja_PM_L1A_1 = Envolvente_compleja_PM_L1A(
            Ac=Ac,
            Kp=Kp,
        )
        ...
        # Connections
        ##################################################
        self.connect((self.Envolvente_compleja_PM_L1A_1, 0), (self.blocks_complex_to_mag_0, 0))
        self.connect((self.Envolvente_compleja_PM_L1A_1, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.Envolvente_compleja_PM_L1A_1, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.Envolvente_compleja_PM_L1A_1, 0), (self.uhd_usrp_sink_0, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.Envolvente_compleja_PM_L1A_1, 0))
    ...
    def set_Kp(self, Kp):
        self.Kp = Kp
        self.Envolvente_compleja_PM_L1A_1.set_Kp(self.Kp)
    ...
    def set_Ac(self, Ac):
        self.Ac = Ac
        self.Envolvente_compleja_PM_L1A_1.set_Ac(self.Ac)
