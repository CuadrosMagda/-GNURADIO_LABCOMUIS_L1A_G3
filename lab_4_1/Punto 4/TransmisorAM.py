...
class TransmisorAM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._Ka_range = Range(-1, 4, 0.0001, -1, 200)
        ...
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/labcom/Escritorio/L1A_G3_M_S/lab_4_1/Punto 4/Audio_de_prueba.wav', True)
        ...
        self._A_win = RangeWidget(self._A_range, self.set_A, "Amplitud Señal Modulante", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.connect((self.rational_resampler_xxx_0, 0), (self.Calculodepotencias_0, 0))
